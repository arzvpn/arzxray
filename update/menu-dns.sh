...
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}                 •USER LOG•                ${NC} $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
read -p "│  DNS : " setdnss
...
echo -e "$COLOR1│${NC}  $COLOR1 [1]$NC • CHANGE DNS       $COLOR1 [3]$NC • CONTENT CEK" 
echo -e "$COLOR1│${NC}  $COLOR1 [2]$NC • RESET DNS        $COLOR1 [4]$NC • REBOOT"
echo -e "$COLOR1│${NC}  $COLOR1 [3]$NC • CONTENT CEK" 
echo -e "$COLOR1│${NC}  $COLOR1 [4]$NC • REBOOT"
