...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[1]${NC} • RUNNING           ${COLOR1}[5]${NC} • TCP TWEAK"
echo -e " $COLOR1│$NC   ${COLOR1}[2]${NC} • SET BANNER        ${COLOR1}[6]${NC} • RESTART ALL"
echo -e " $COLOR1│$NC   ${COLOR1}[3]${NC} • BANDWITH USAGE    ${COLOR1}[7]${NC} • AUTO REBOOT"
echo -e " $COLOR1│$NC   ${COLOR1}[4]${NC} • ANTI TORRENT $sts  ${COLOR1}[8]${NC} • SPEEDTEST"
echo -e " $COLOR1│$NC"
