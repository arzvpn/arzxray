...
bbr_status
echo -e "$COLOR1│${NC}  "
echo -e "$COLOR1│${NC}  ${COLOR1}[1]${NC} • Install BBR "
echo -e "$COLOR1│${NC}  ${COLOR1}[2]${NC} • Install TCP 1 "
echo -e "$COLOR1│${NC}  ${COLOR1}[3]${NC} • Install TCP 2 "
echo -e "$COLOR1│${NC}  ${COLOR1}[4]${NC} • Delete BBR "
echo -e "$COLOR1│${NC}  ${COLOR1}[5]${NC} • Delete TCP 1"
