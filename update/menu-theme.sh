...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC  $COLOR1 [1]$NC • BLUE YODO     $COLOR1 [4]$NC • CYAN MEOW"
echo -e " $COLOR1│$NC  $COLOR1 [2]$NC • RED HOTLINK   $COLOR1 [5]$NC • GREEN DAUN"
echo -e " $COLOR1│$NC  $COLOR1 [3]$NC • YELLOW DIGI   $COLOR1 [6]$NC • MAGENTA AXIS"
echo -e " $COLOR1│$NC"
