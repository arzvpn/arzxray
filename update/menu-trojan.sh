...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[1]${NC} • CREATE TROJAN ACCOUNT(${BLUE}addtrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[2]${NC} • TRIAL TROJAN(${BLUE}trialtrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[3]${NC} • RENEW TROJAN(${BLUE}renewtrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[4]${NC} • DELETE TROJAN(${BLUE}deltrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[5]${NC} • CHECK USER ACTIVE(${BLUE}cektrojan${NC}) $NC"
