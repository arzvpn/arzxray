...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[1]${NC} • CREATE TROJAN ACCOUNT(${COLOR1}addtrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[2]${NC} • TRIAL TROJAN(${COLOR1}trialtrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[3]${NC} • RENEW TROJAN(${COLOR1}renewtrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[4]${NC} • DELETE TROJAN(${COLOR1}deltrojan${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[5]${NC} • CHECK USER ACTIVE(${COLOR1}cektrojan${NC}) $NC"
