...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[1]${NC} • CREATE VLESS ACCOUNT(${COLOR1}addvless${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[2]${NC} • TRIAL VLESS(${COLOR1}trialless${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[3]${NC} • RENEW VLESS(${COLOR1}renewvless${NC}) $NC"
echo -e " $COLOR1│$NC   ${COLOR1}[4]${NC} • DELETE VLESS(${COLOR1}delvless${NC}) $NC"   
echo -e " $COLOR1│$NC   ${COLOR1}[5]${NC} • CHECK USER ACTIVE(${COLOR1}cekvless${NC}) $NC"
