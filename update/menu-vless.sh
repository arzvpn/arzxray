...
echo -e "$COLOR1│${NC} Path WSS      : wss://yourbug/vless" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[1]${NC} • ADD VLESS      ${COLOR1}[3]${NC} • DELETE VLESS${NC}   $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[2]${NC} • RENEW VLESS${NC}    ${COLOR1}[4]${NC} • USER ONLINE    $COLOR1│$NC"
