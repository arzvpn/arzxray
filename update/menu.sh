...
echo -e "$COLOR1┗─━─━─━─━─━─━─━─━─━─━─━─━─━─━─━∞◆∞━─━─━─━─━─━─━─━─━─━─━─━─━─━─┛${NC}"
echo -e "$COLOR1╔─━━━━━━━━━━━━━━━━━━━━━━━━━━━━━░★░━━━━━━━━━━━━━━━━━━━━━━━━━━━─╗${NC}"
echo -e "  ${COLOR1}[1]${NC}  • SSH WS(${BLUE}menu-ssh${NC})  "   
echo -e "  ${COLOR1}[2]${NC}  • VMESS(${BLUE}menu-vmess${NC}) "  
echo -e "  ${COLOR1}[3]${NC}  • VLESS(${BLUE}menu-vless${NC}) "  
echo -e "  ${COLOR1}[4]${NC}  • TROJAN  WS(${BLUE}menu-trojan${NC}) "  
echo -e "  ${COLOR1}[5]${NC}  • SHADOWSOCKS WS(${BLUE}menu-ss${NC})  "
echo -e "  ${COLOR1}[6]${NC}  • ADD HOST/DOMAIN(${BLUE}add-host${NC}) "
echo -e "  ${COLOR1}[7]${NC}  • RENEW CERT/GEN SSL(${BLUE}crtxray${NC}) "
echo -e "  ${COLOR1}[8]${NC}  • BACKUP(${BLUE}menu-backup${NC}) "
echo -e "  ${COLOR1}[9]${NC}  • THEME(${BLUE}menu-theme${NC}) "
echo -e "  ${COLOR1}[10]${NC} • SETTINGS(${BLUE}menu-set${NC}) "
echo -e "  ${COLOR1}[11]${NC} • INFO AUTOSCRIPT(${BLUE}info${NC}) "
echo -e "$COLOR1╚─━━━━━━━━━━━━━━━━━━━━━━━━━━━━░★░━━━━━━━━━━━━━━━━━━━━━━━━━━─╝${NC}"
myver="$(cat /opt/.ver)"
